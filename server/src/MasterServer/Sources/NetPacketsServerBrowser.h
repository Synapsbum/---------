...
enum sbpktType_e
{
  ...
  SBPKT_G2M_SetBRGameStatus,//AlexRedd:: BR mode
...
struct SBPKT_G2M_SetBRGameStatus_s : public r3dNetPacketMixin<SBPKT_G2M_SetBRGameStatus>//AlexRedd:: BR mode
{
	DEFINE_GAME_RELAYING_PACKET(SBPKT_G2M_SetBRGameStatus_s)
	BYTE status;
};
