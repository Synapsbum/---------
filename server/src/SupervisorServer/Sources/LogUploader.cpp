...
#if LOCAL
static	const char*	gDomainBaseUrl= "/zh/api/"; // ptumik: switched to non SSL due to random connection issues on SSL port
static	int			gDomainPort   = 80;
static	bool		gDomainUseSSL = false;
#endif
...
CLogUploader::CLogUploader()
{
	...
	bool success = http_.UnlockComponent("wLiu9P.CB10599_JruQWlT4Da2k");
...
int CLogUploader::UploadDataToServer(CFileData& logdata, CFileData& dmpdata, CFileData& jpgdata)
{
	...
	req.AddParam("skey1", "KfZnUUwZFJqrPJ1b4DaNZ3CkGnvz6MzPYAvP86wg");//Fg5jaBgj3uy3ja
