...
IMPLEMENT_CLASS(obj_ServerSellNPC, "obj_SellNPC", "Object");
AUTOREGISTER_CLASS(obj_ServerSellNPC);
...
obj_ServerSellNPC::obj_ServerSellNPC() 
{
}
...
BOOL obj_ServerSellNPC::OnCreate()
{
	parent::OnCreate();
